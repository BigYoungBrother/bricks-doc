- [Timer](#timer)
  - [01 用法](#01-用法)
    - [0x01 使用实例](#0x01-使用实例)
    - [0x02 Timer的构造方法详解](#0x02-timer的构造方法详解)
    - [0x03 schedule方法的参数详解](#0x03-schedule方法的参数详解)
  - [02 源码详解](#02-源码详解)
    - [0x01 原理](#0x01-原理)
    - [0x02 TimerTask](#0x02-timertask)
    - [0x03 Timer](#0x03-timer)
    - [0x04 TaskQueue](#0x04-taskqueue)
    - [0x05 TimerThread](#0x05-timerthread)
